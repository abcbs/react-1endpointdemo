...
(function( $, undefined ) {
	...
	$.mobile._registerInternalEvents = function() {//注册事件
	...
	$.when( domreadyDeferred, $.mobile.navreadyDeferred ).done( function() {
		//在init页面中的initializePage方法中完成页面装载，执行mobile.navreadyDeferred
		//注册事件
		$.mobile._registerInternalEvents();//异步执行_registerInternalEvents
	} );
})( jQuery );
//>>excludeStart("jqmBuildExclude", pragmas.jqmBuildExclude);
});
