...
define( [ "jquery", "../jquery.mobile.widget", "../jquery.mobile.core",
	"../jquery.mobile.animationComplete", "../jquery.mobile.navigation",
	"./page","./toolbar","../jquery.mobile.zoom" ],
function( jQuery ) {
...
(function( $, undefined ) {
	...
	$.widget( "mobile.toolbar", $.mobile.toolbar, {
		...
		_create: function() {
			this._super();//执行父类的构造方法
			this.pagecontainer = $( ":mobile-pagecontainer" );//获取所有类型为页面容器的元素
