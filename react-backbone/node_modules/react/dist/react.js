...
//匿名立即执行函数的参数，即函数f的定义。
(function(){//此函数
  var define,module,exports;//函数f中的变量
  return (function e(t,n,r){//定义函数e,并且立即执行，方式为(function e(t,n,r)({}.{},[1]),e函数返回s(o,u)
                              //t为对象，此结构为1:[],2:[],3:[],r为传入的数组即[0]
    function s(o,u){//参数o为整数
      if(!n[o]){//如果没有定义此函数，即e中传入的第二个参数n
        if(!t[o]){//取出t结构中的第一个，这里的o循环获得，目前为1，即{["117":117,"114":114]}
          var a=typeof require=="function"&&require;
          if(!u&&a)//如果没有定义u并且a存在，则执行a,a的值为require函数
            return a(o,!0);//执行require函数
          if(i)//定义了U，并且有require
            return i(o,!0);
          //否则抛出异常
          var f=new Error("Cannot find module '"+o+"'");
          throw f.code="MODULE_NOT_FOUND",f
        }//如果没有获取t[o]，即t[1]
        var l=n[o]={exports:{}};//定义exports,定义变量L
        t[o][0].call(l.exports,//l为调用call的上下文,t[1],t为对象，本身为{1:[{},{["117":117,"114":114]},
            //function(_dereq_,module,exports)                            2:[{},{["117":117,"114":114]}],
            function(e){//第一个参数，参数e为1,19。当使用_dereq_查找时执行s(n)
              var n=t[o][1][e];//[t[o][1]为{["117":117,"114":114]，
              var dereq= s(n?n:e);//在function(_dereq_,module,exports)中调用时为递归调用
              //return s(n?n:e)
              return dereq;
            },
            l,//第二个参数module，
            l.exports,//第三个参数exports
            e,//在call执行之前为e函数，在执行call中为function(e)时为传入参数，如19
            t,//下面三个为传入的参数
            n,
            r)//call方法中的第一个参数为thisObject，在这里为l.exports。
              // 在call中增加的变量有(_dereq_,module,exports)需要的参数，function(e)，l和l.exports
              // 还有需要保持的上下文，e。t，n，t，这些变量在执行_dereq_根据上下文取值不同
      }//if !n[o]-over
      var nexp=n[o].exports;
      return nexp//递归调用返回结果
    }//s(o,u)
    var i=typeof require=="function"&&require;
    for(var o=0;o<r.length;o++)//从r，即第三个参数，在结构中传入的为数组，即[1]
      s(r[o]);//从第三个取出数据，即值1
    return s;//s(o,u)方法
    }//e(t,n,r)-over
  )//return-over,function e(t,n,r)
...
},//function(_dereq_,module,exports {}方法定义结束，它们组成1:{}
      {"117":117,"144":144,"19":19,"21":21,"27":27,"32":32,"33":33,"34":34,"38":38,"39":39,"40":40,"51":51,"54":54,
      "57":57,"58":58,"66":66,"70":70,"75":75,"78":78,"81":81,"84":84}//第二个对象
  ],//第一个函数定义结束
